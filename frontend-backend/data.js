...
//elimina
  $("body").on("click", "#btn-delete", function () {
    ...
    $.ajax({
      ...
      type: "delete", //si dice di voler cancellare dal db
      success: function(data){
        

        displayTable(chiamataServer(url+"?page="+response['page']['number']+"&size=20"));}//e se ha successo(significa che è stata cancellata) si da la url al display table
  })
  });
